# Research Design: test-run-1-n400

Full-scale replication of `test-run-1` (N=20 pilot) at N=400. Same design, population, stimuli, and outcome variables -- only the sample size changed. Not run blind: arm assignment is known from the start, carried forward from the pilot's unblinding.
...
See `variables_spec.md` (unchanged from pilot).
